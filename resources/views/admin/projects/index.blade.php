   ...
   class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
    ...
    <div class="flex gap-3">
        ...
        <a href="{{ route('admin.projects.edit', $project) }}" 
           ...
           style="color: #4f46e5; transition: color 0.2s;"
        ...
        <form action="{{ route('admin.projects.destroy', $project) }}" 
            ...
            <button type="submit" 
                    ...
                    style="color: #dc2626; transition: color 0.2s; background: none; border: none; cursor: pointer; padding: 0;"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    @else
                        <div class="text-center py-8">
                            <p class="text-gray-500 mb-4">No hay proyectos aún. ¡Crea tu primer proyecto!</p>
                            <a href="{{ route('admin.projects.create') }}" 
