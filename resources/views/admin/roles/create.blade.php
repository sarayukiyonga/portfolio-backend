                    ...
                    <form action="{{ route('admin.roles.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="ej: editor, moderador, cliente"
                                   required>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" 
                                      ...
                                      placeholder="Describe los permisos y funciones de este rol">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6 p-4 bg-blue-50 rounded-md">
                            <h4 class="text-sm font-medium text-blue-800 mb-2">💡 Ejemplos de roles comunes:</h4>
                            <ul class="text-sm text-blue-700 space-y-1">
                                <li><strong>editor:</strong> Puede crear y editar contenido</li>
                                <li><strong>moderador:</strong> Puede moderar comentarios y usuarios</li>
                                <li><strong>cliente:</strong> Usuario registrado con permisos básicos</li>
                                <li><strong>contribuidor:</strong> Puede enviar contenido para revisión</li>
                            </ul>
                        </div>
